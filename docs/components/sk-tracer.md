...
trace for use by the simulator. The objects that the tracer will watch can be configured via a passed in config file
(see the [tracer config reference](../ref/tracer-config.md).
