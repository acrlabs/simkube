...
#[fixture]
fn test_trace() -> ExportedTrace {
    ExportedTrace::default()
}

#[rstest]
fn test_lookup_pod_lifecycle_no_owner(test_trace: ExportedTrace) {
...
#[rstest]
fn test_lookup_pod_lifecycle_no_hash(mut test_trace: ExportedTrace) {
...
#[rstest]
fn test_lookup_pod_lifecycle(mut test_trace: ExportedTrace) {
...
#[rstest]
fn test_trace_start_end_ts(mut test_trace: ExportedTrace) {
